...
// Апостроф экранируется как &apos;, а НЕ как &#39;. Разница принципиальная:
// linkifyMentions() работает уже по экранированному тексту и ищет там #тег —
// а в «&#39;» он находил «#39» и превращал апостроф в кликабельный хештег.
// На экране вместо «я'м» получалось «&#39;» вперемешку с разметкой.
// В &apos; решётки нет, поэтому ловить нечего.
